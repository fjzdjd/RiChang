...
public class About extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((RelativeLayout) findViewById(R.id.showwechat)).setOnClickListener(new View
                .OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        ((RelativeLayout) findViewById(R.id.checkVersion)).setOnClickListener(new View
                .OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    class LogoCliclk implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            ImageLoader.getInstance().displayImage(str, logo, new DisplayImageOptions.Builder()
