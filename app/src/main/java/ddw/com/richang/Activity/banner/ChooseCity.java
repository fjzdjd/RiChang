...
public class ChooseCity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Config.CITYS.size()>0) showCity();
                ...
                try{
                    ...
                    if(200==obj.getInt("code")){
                        ...
                        for(int i=0;i<array.length();i++){
                            Config.CITYS.add(new IdNameMap(array.getJSONObject(i).getLong("ct_id"),array.getJSONObject(i).getString("ct_name")));
                        }
    ...
    private void showCity(){
        ...
        for(int i=0;i<Config.CITYS.size();i++){
            ...
            final String url=Config.getInterface().picDomain+"/img/city/"+Config.CITYS.get(i).id+".png";
            ...
            onecity.setPadding(18 * Config.SCALE, 20 * Config.SCALE, 18 * Config.SCALE, 20 * Config.SCALE);
            ...
            loc.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, height));
            loc.setVisibility(Config.getUSR().getCity().id==Config.CITYS.get(i).id?View.VISIBLE:View.GONE);
