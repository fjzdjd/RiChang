...
public class DownloadService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String urlStr = intent.getStringExtra(ConstantData.APK_DOWNLOAD_URL);
        InputStream in = null;
        ...
        try {
            ...
            installAPKIntent.setDataAndType(Uri.fromFile(apkFile), "application/vnd.android" +
                    ".package-archive");
    ...
    private void updateProgress(int progress) {
        //"正在下载:" + progress + "%"
        mBuilder.setContentText(this.getString(R.string.download_progress, progress)).setProgress
                (100, progress, false);
