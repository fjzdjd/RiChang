...
package ddw.com.richang.controller.shareSDK.cn.sharesdk.onekeyshare;
	...
	public void show(Context context) {
		...
		try {
			if(OnekeyShareTheme.SKYBLUE == theme){
				platformListFakeActivity = (PlatformListFakeActivity) Class.forName("ddw.com.richang.controller.shareSDK.cn.sharesdk.onekeyshare.theme.skyblue.PlatformListPage").newInstance();
			}else{
				platformListFakeActivity = (PlatformListFakeActivity) Class.forName("ddw.com.richang.controller.shareSDK.cn.sharesdk.onekeyshare.theme.classic.PlatformListPage").newInstance();
			}
		} catch (Exception e) {
			e.printStackTrace();
			return;
