package ddw.com.richang.controller.view.flash;
...
public class UnViewpager extends ViewPager {
    ...
    public UnViewpager(Context paramContext) {
        super(paramContext);
        init();
    }

    public UnViewpager(Context paramContext, AttributeSet paramAttributeSet) {
    ...
    private static class MyHandler extends Handler {
        ...
        private final WeakReference<UnViewpager> autoScrollViewPager;

        public MyHandler(UnViewpager autoScrollViewPager) {
            this.autoScrollViewPager = new WeakReference<UnViewpager>(autoScrollViewPager);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SCROLL_WHAT:
                    UnViewpager pager = this.autoScrollViewPager.get();
                    if (pager != null) {
