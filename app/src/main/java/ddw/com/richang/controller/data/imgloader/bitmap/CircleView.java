...
/**
 * Created by dingdewen on 16/3/21.
 */
public class CircleView implements BitmapDisplayer{

    public static DisplayImageOptions BITMAPDISPLAYER=new DisplayImageOptions.Builder().cacheInMemory(true).cacheOnDisk(true).displayer(new CircleView()).build();
