package ddw.com.richang.custom.refresh;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    private void sendCancelEvent() {
        ...
        MotionEvent e = MotionEvent.obtain(last.getDownTime(),
                last.getEventTime() + ViewConfiguration.getLongPressTimeout(), MotionEvent
                        .ACTION_CANCEL, last.getX(),
    ...
    private void sendDownEvent() {
        ...
        MotionEvent e = MotionEvent.obtain(last.getDownTime(), last.getEventTime(), MotionEvent
                .ACTION_DOWN,
    ...
    class ScrollChecker implements Runnable {
        ...
        public void run() {
            ...
            if (DEBUG) {
                if (deltaY != 0) {
                    PtrCLog.v(LOG_TAG,
                            "scroll: %s, start: %s, to: %s, currentPos: %s, current :%s, last: " +
                                    "%s, delta: %s", finish,
